// src/data/blogPosts/best-miniature-paints-beginners-2025.js
...
const content = `
  ...
  <h3>1. Citadel Paint + Tool Set ($45.00)</h3>
  ...
  <div class="affiliate-section">
    <a target="_blank" href="https://amzn.to/4mQarnO" class="btn btn-primary affiliate-btn">🛒 Shop Citadel Paint Set on Amazon</a>
    <p class="affiliate-note">As an Amazon Associate, we earn from qualifying purchases.</p>
  </div>

  <h3>2. Vallejo Game Color Intro Set ($40.00)</h3>
  ...
  <div class="affiliate-section">
    <a target="_blank" href="https://amzn.to/47yXbiN" class="btn btn-primary affiliate-btn">🛒 Get Vallejo Model Color Set</a>
  </div>

  <h3>3. Army Painter Warpaints Starter Paint Set ($39.99)</h3>
  ...
  <p><strong>Cons:</strong></p>
  <ul>
    <li>Limited color selection in starter set</li>
    <li>Paint consistency can vary between batches</li>
    <li>Bottles can be prone to clogging</li>
    <li>Not as widely available as Citadel</li>
  </ul>
  <div class="affiliate-section">
    <a target="_blank" href="https://amzn.to/3HE5y1X" class="btn btn-primary affiliate-btn">🛒 Shop Army Painter Set</a>
  </div>
