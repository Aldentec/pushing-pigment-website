...
const Products = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Best Miniature Painting Supplies & Tools 2025 | Product Reviews</title>
        <meta name="description" content="Discover the top-rated miniature painting supplies with expert reviews. Find the best brushes, paints, primers, and tools with Amazon prices and ratings." />
        <link rel="canonical" href="https://pushingpigment.com/products" />
      </Helmet>
